...
public class AdminController implements Serializable {
    ...
    public Employe find() {
        System.out.println("haniiiiii f find");
        return (Employe) util.Session.getAttribut("UserEmploye");
    }
    public Employe mdpMod(){
        Employe employe=find();
        if(!employe.getUserConnexion().isMdpChanged()){
            return employe;
        }else{
            return null;
        }
    ...
    public Admin getSelected() {
        if( selected==null){
            System.out.println("haa l'id dyal  selecteddd f find"+find().getId());
            selected= ejbFacade.find(find().getId());
